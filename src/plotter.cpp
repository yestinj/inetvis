...
unsigned int Plotter::ipColRange[2] = {0, MAX_U_INT32_VAL}; //full address range
unsigned int Plotter::icmpColRange[2] = {0, MAX_U_INT16_VAL}; //full type-code range
unsigned int Plotter::tcpColRange[2] = {0, MAX_U_INT16_VAL}; //full port range
unsigned int Plotter::udpColRange[2] = {0, MAX_U_INT16_VAL}; //full port range
...
unsigned int Plotter::ipColRangeLength = MAX_U_INT32_VAL;
unsigned int Plotter::icmpColRangeLength = MAX_U_INT16_VAL;
unsigned int Plotter::tcpColRangeLength = MAX_U_INT16_VAL;
unsigned int Plotter::udpColRangeLength= MAX_U_INT16_VAL;
...
void Plotter::setIpColRange(unsigned int start, unsigned int end)
{
    ipColRange[0] = start;
    ipColRange[1] = end;
    ipColRangeLength = ipColRange[1] - ipColRange[0];

#ifdef DEBUG_PLOTTER
    cout << "DEBUG: Plot: set IP colour range col0=" << colRange[0] << ", col1="
         << colRange[1] << ", rangecol=" << colRangeLength << "\n";
#endif
...
void Plotter::setIcmpColRange(unsigned int start, unsigned int end)
{
    Plotter::colRange[0] = start;
    Plotter::colRange[1] = end;
    Plotter::colRangeLength = Plotter::colRange[1] - Plotter::colRange[0];

#ifdef DEBUG_PLOTTER
    cout << "DEBUG: Plot: set ICMP colour range col0=" << colRange[0] << ", col1="
         << colRange[1] << ", rangecol=" << colRangeLength << "\n";
#endif
...
void Plotter::setTcpColRange(unsigned int start, unsigned int end)
{
    Plotter::colRange[0] = start;
    Plotter::colRange[1] = end;
    Plotter::colRangeLength = Plotter::colRange[1] - Plotter::colRange[0];
...
#ifdef DEBUG_PLOTTER
    cout << "DEBUG: Plot: set TCP colour range col0=" << colRange[0] << ", col1="
         << colRange[1] << ", rangecol=" << colRangeLength << "\n";
#endif
...
void Plotter::setUdpColRange(unsigned int start, unsigned int end)
{
    Plotter::colRange[0] = start;
    Plotter::colRange[1] = end;
    Plotter::colRangeLength = Plotter::colRange[1] - Plotter::colRange[0];
...
#ifdef DEBUG_PLOTTER
    cout << "DEBUG: Plot: set UDP colour range col0=" << colRange[0] << ", col1="
         << colRange[1] << ", rangecol=" << colRangeLength << "\n";
#endif
...
void Plotter::plot(PacketEvent &pe)
{
    ...
    if (pe.headers.dataLinkType == DL_ETHERNET)
    {
        if (pe.headers.networkType == N_IPv4)
        {
            ...
            //Generic colour maps (IP, packet size)
            ...
            //Protocol specific colour maps and plotting
